...
urlpatterns = patterns('',
                       ...
                       url(r'^balchanges/(?P<days_back>\d+)/$', views.balance_changes),
                       url(r'^search/(?P<keyword>.+)/$', views.search_transactions),
                       url(r'^search/$', views.search_none),
                       url(r'^computebal/$', views.compute_balances),
                       url(r'^computebal/(?P<days_back>\d+)/$', views.compute_balances),
                       url(r'^login/$', login),
